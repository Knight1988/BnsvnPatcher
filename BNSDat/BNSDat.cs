...
namespace BNSDat
{
  public class BNSDat
  {
    ...
    public void Extract(string FileName, bool is64 = false, Action<double, double> progress = null)
    {
      ...
      for (int index = 0; index < num2; ++index)
      {
        ...
        string str2 = "Extracting: " + index.ToString() + "/" + num2.ToString();
          if (progress != null) progress(index, num2);
      }
      binaryReader2.Close();
      memoryStream1.Close();
      binaryReader1.Close();
    ...
    public void Compress(string Folder, bool is64 = false, Action<double, double> progress = null, int compression = 9)
    {
      ...
      for (int index = 0; index < num1; ++index)
      {
        ...
        string str2 = "Compiling: " + index.ToString() + "/" + num1.ToString();
          if (progress != null) progress(index, num1);
      }
